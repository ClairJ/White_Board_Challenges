...
//   for (let i = 1; i < mid; i++) list = list.next;
...
solution.answer = function(linkedlist) {
  if(linkedlist.size() === 0) {
    return null;
  }
  return linkedlist.elementAt(Math.ceil(linkedlist.size()/2)-1);
};

var conga = new solution.LinkedList();
conga.add(5);
conga.add(120);
conga.add(88);
conga.add(13);
